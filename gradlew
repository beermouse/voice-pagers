...
#   Important for use:
#
#   In order to run referenced Gradle App in a standard way, the script will
#   try to use the default java via the PATH or JAVA_HOME if set.
#
##############################################################################
...
if [ -n "$JAVA_HOME" ] ; then
    if [ -x "$JAVA_HOME/bin/java" ] ; then
        # Countermeasure for Bug 6701191.
...
# Collect all arguments for the java command except the command line arguments
